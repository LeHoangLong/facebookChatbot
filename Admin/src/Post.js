        ...
        <div className="position-relative p-4" ref={root} >
            <div className="d-flex w-100">
                ...
                <div className="d-flex flex-column">
                    <i aria-role="button" aria-label="Expand" ref={expand_button} onClick={e => {props.onToggleShowEdit(!showEdit); e.stopPropagation()}} className="fas fa-ellipsis-h mb-2 faded_hoverable cursor_pointer"></i>
                </div>
            </div>
            <div ref={edit_box} className="position-absolute bg-light d-flex flex-column" style={{ overflow: 'hidden', height: `${height}px`, left: '100%', top: '0', transition: 'height 0.5s', boxSizing: 'border-box'}}>
                <i aria-role="button" aria-label="Edit"  className="p-2 fas fa-edit faded_hoverable cursor_pointer border flex-grow-1" onClick={ props.onEditClicked }>Edit</i>
                <i aria-role="button" aria-label="Delete"  className="p-2 fas fa-trash faded_hoverable cursor_pointer border flex-grow-1">Delete</i>
            </div>
        </div>
    )
}